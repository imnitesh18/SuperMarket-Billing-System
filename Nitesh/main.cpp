...
void shopping ::menu() {
    ...
    switch(choice) {
        case 1:
            ...
            if (email == "malinitesh2001@gmail.com" && password == "nitesh@123") {
                administrator();
            } else {
...
void shopping ::receipt() {
    ...
    if(!data){
        ...
        do{
         ...
         while(choice =='y');
         cout<<"\n\n\t\t\t____________________________________RECEIPT________________________________\n";
